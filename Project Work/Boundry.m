%this code is not working, wrote for finding 4 edges of signboard using
%haugh trasform
function Boundry()
filename='57.jpg';
close all;
...
angles      =  [0,180,90,-90];  
    for angle = angles
        ...
        %houghpeaks
        lines = houghlines(mag_at_angle,theta,rho,peaks,'FillGap',4,'MinLength',5);
        subplot(2,2,counter);
